...
3\. __Jones, P. J.__, Simon, T., Zeileis, A., & Mair, P. (2018). networktree: Recursive partitioning of network models. _R package version 0.2.0._ https://CRAN.R-project.org/package=networktree

2\. van Borkulo, C., Epskamp, S., Millner, A., & __Jones, P. J.__ (2017). NetworkComparisonTest: Statistical comparison of two networks based on three invariance measures. https://CRAN.R-project.org/package=NetworkComparisonTest
...
3\. Vanzhula, I. A., Christian, C. __Jones, P. J.___, ... & Levinson, C. A. (in review). Replicability of eating disorder psychological networks in five samples: Conceptual and methodological considerations.
